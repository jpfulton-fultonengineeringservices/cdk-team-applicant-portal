    ...
    private static addNagSuppressions(
        ...
        NagSuppressions.addResourceSuppressions(
            ...
            [
                {
                    id: 'AwsSolutions-S1',
                    reason: 'This IS the CloudFront access logs bucket. Enabling server access logging on it would create a circular dependency.',
                },
            ],
            true
        );
            ...
            [
                {
                    ...
                    reason: 'Geo restrictions are not required for this applicant portal. Applicants may be located anywhere in the world.',
                },
                {
                    id: 'AwsSolutions-CFR2',
                    reason: 'WAF integration is not required for this portal. Lambda@Edge authentication provides the primary access control layer.',
                },
                {
            ...
            [
                {
                    ...
                    reason: 'Lambda@Edge uses AWSLambdaBasicExecutionRole managed policy for CloudWatch Logs. This is the AWS-recommended approach.',
                    appliesTo: ['Policy::arn:<AWS::Partition>:iam::aws:policy/service-role/AWSLambdaBasicExecutionRole'],
                },
                {
                    id: 'AwsSolutions-IAM5',
                    reason: 'Lambda@Edge execution role requires wildcard log group permissions because edge log groups are created dynamically in all regions.',
                    appliesTo: ['Resource::*'],
                },
            ],
            true
