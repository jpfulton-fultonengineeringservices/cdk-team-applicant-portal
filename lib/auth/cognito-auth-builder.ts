            ...
            [
                {
                    ...
                    reason: 'MFA is set to OPTIONAL per product decision. Applicants are short-term users; mandatory MFA would create support burden for a temporary credential.',
                },
                {
                    id: 'AwsSolutions-COG3',
                    reason: 'Advanced security (threat protection) requires the PLUS feature plan. Essentials plan is intentional for this use case.',
                },
            ],
            true
        );
